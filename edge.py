...
inputfolder="F:/CR/picture_1_22/Original/"           #the name of the folder that store original files
originalnames=os.listdir(inputfolder)                #Get the names of original files
originalnames.sort(key=lambda x:int(x[-9:-4]))

outputfolder='F:/CR/picture_1_22/Post/'                           #the name of the folder that store post files
